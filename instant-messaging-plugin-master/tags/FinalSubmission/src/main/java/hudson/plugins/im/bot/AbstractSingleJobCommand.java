...
abstract class AbstractSingleJobCommand extends AbstractTextSendingCommand {
	 ...
	 *            The number of arguments (in addition to the job name) required
	 *            by this command. Number of actual specified arguments may be
	 *            equal or greater.
	 */
	 ...
	 * 
	 * Implementors should only return a String if the command was executed
	 * successfully. Otherwise a {@link CommandException} should be thrown!
	 * 
	 * @param job
	 *            The job
	 * @param sender
	 *            The sender of the command
	 * @return the result message for this job if the command was executed
	 *         successfully
	 * @throws CommandException
	 *             if the command couldn't be executed for any reason
	 */
	protected abstract CharSequence getMessageForJob(AbstractProject<?, ?> job, Sender sender, String[] arguments)
			throws CommandException;

	/**
	 * Retrieve the permission of the certain project
	 * 
	 * @return The permission of the certain project
	 */
