 ...
 * @author Origionally by: <a href="http://www.jibble.org/">Paul James
 *         Mutton</a> for
...
public final class IRCColors {
	...
	public static final ImmutableMap<String, String> COLORS_TABLE = ImmutableMap.<String, String> builder()
			.put("WHITE", WHITE).put("BLACK", BLACK).put("DARK_BLUE", DARK_BLUE).put("DARK_GREEN", DARK_GREEN)
			.put("RED", RED).put("BROWN", BROWN).put("PURPLE", PURPLE).put("OLIVE", OLIVE).put("YELLOW", YELLOW)
			.put("GREEN", GREEN).put("TEAL", TEAL).put("CYAN", CYAN).put("BLUE", BLUE).put("MAGENTA", MAGENTA)
			.put("DARK_GRAY", DARK_GRAY).put("LIGHT_GRAY", LIGHT_GRAY).build();
	/**
	...
	public static final ImmutableMap<String, String> FORMATTING_TABLE = ImmutableMap.<String, String> builder()
			.put("NORMAL", NORMAL).put("BOLD", BOLD).put("UNDERLINE", UNDERLINE).put("REVERSE", REVERSE)
			.put("ITALICS", ITALICS).build();
	/**
	...
	public static final ImmutableMap<String, String> LOOKUP_TABLE = ImmutableMap.<String, String> builder()
			.putAll(COLORS_TABLE).putAll(FORMATTING_TABLE).build();
	 ...
	 *
	 * @param colorName
	 *            Name of field in this class, will be converted to uppercase
